...
int main(int argc, char* args[])
{
	...
	vec3 objectPosition = vec3(0.0f, 10.0f, 0.0f);
	...
	carShape->calculateLocalInertia(mass, fallInertia);

	btRigidBody::btRigidBodyConstructionInfo fallRigidBodyCI(mass, fallMotionState, carShape, fallInertia);
