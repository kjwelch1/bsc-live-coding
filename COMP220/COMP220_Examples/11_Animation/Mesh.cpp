...
void Mesh::copyBufferData(Vertex * pVerts, unsigned int numberOfVerts, unsigned int * pIndices, unsigned int numberOfIndices)
{
	...
	glVertexAttribIPointer(4, 4, GL_INT, sizeof(Vertex), (void*)(12 * sizeof(float)));

	glEnableVertexAttribArray(5);
	glVertexAttribPointer(5, 4, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)(12 * sizeof(float) + 4 * sizeof(int)));
